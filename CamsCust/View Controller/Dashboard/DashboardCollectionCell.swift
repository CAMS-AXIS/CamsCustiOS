...
class DashboardCollectionCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        var string: NSMutableAttributedString = NSMutableAttributedString(string: "Brand \n 25%")
        string.setColor(color: UIColor.systemPink, forText: "Brand")
        string.setColor(color: UIColor.black, forText: "25%")
